...
@Composable
fun ColumnScope.exportResultFileSavedSuccessfullyContent(
    ...
    Column(
        ...
        content = {
            ...
            Image(
                ...
                contentDescription = stringResource(R.string.illustration_confirmation_description)
            )
        }
    )
        ...
        content = {
            ...
            Column(
                ...
                content = {
                    ...
                    headlineLarge(text = stringResource(R.string.file_saved_successfully))

                    spacerV8()

                    bodyLarge(
                        text = stringResource(R.string.file_saved_successfully_explanation),
            ...
            Column(
                ...
                content = {
                    ...
                    primaryButton(
                        ...
                        testTag = TestTags.EXPORT_RESULT_SCREEN_PRIMARY_BUTTON_CONTINUE
                    )
                }
            )
        }
